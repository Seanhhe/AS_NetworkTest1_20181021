package tw.sean.as_networktest1_20181021;
/*
 * 01.AndroidManifest.xml中增加<uses-permission android:name="android.permission.INTERNET"/>
 * 02.實作由webView瀏覽網頁，a)執行緒做法 b)okhttp通訊協定做法 c)
 */
